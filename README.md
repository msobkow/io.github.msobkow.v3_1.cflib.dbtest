...
CFLib DbTest was used to exercise and prototype the use of the various database types in CFLib DbUtil, and to prototype the multi-JPA repository framework needed for the Code Fractal vision of how code should be structured.
